...
md.friction.coefficient = 1.*ones(md.mesh.numberofvertices, 1); % Set the friction coefficient again for redundancy
...
description = 'long leadup GLOF, starting from kyagar14_wsu_C1_outflow.mat with , max flux=0.5,  max gap height = 100m';
save('kyagar14_coupled_outburst_C1_outflow.mat', 'md', 'description','pos', '-v7.3')
